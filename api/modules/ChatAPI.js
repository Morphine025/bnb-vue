...
export class ChatAPI extends BaseAPI {
  ...
  static async getConversation(conversationId) {
    return this.getById('/chat/conversation', conversationId, {
  ...
  static async markMessagesAsRead(conversationId) {
    return this.post(`/chat/read?conversationId=${conversationId}`, {}, {
  ...
  static async pinConversation(conversationId) {
    return this.post(`/chat/pin?conversationId=${conversationId}`, {}, {
      errorMessage: '置顶对话失败'
    })
  }
  ...
  static async unpinConversation(conversationId) {
    return this.post(`/chat/unpin?conversationId=${conversationId}`, {}, {
  ...
  static async deleteConversation(conversationId) {
    return this.post(`/chat/delete?conversationId=${conversationId}`, {}, {
      errorMessage: '删除对话失败'
    })
  }
  ...
  static async autoSendLandlordContact(conversationId, landlordId, homestayId) {
    ...
    return this.post(`/chat/auto-send-contact?${queryParams}`, {}, {
